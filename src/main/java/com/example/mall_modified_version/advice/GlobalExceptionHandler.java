package com.example.mall_modified_version.advice;
...
import com.example.mall_modified_version.exception.IllegalOperationException;
import com.example.mall_modified_version.exception.NotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseVo handleMethodNotAllowed(Exception e, HttpServletRequest request) {
        log.warn(formatException(e, request, null, false));
        return ResponseVo.error(ResponseEnum.ERROR, "请求方式不支持");
    }
    ...
    public ResponseVo handleBadRequest(Exception e, HttpServletRequest request) {
        log.warn(formatException(e, request, null, false));
        return ResponseVo.error(ResponseEnum.ERROR, "请求格式不对");
    }
    ...
    public ResponseVo handleAccessDeniedException(Exception e, HttpServletRequest request) {
        log.warn(formatException(e, request, null, false));
        return ResponseVo.error(ResponseEnum.ERROR, "权限不足");
    }
    ...
    public ResponseVo handleIllegalOperationException(Exception e, HttpServletRequest request) {
        log.warn(formatException(e, request, null, false));
        return ResponseVo.error(ResponseEnum.ERROR, "操作非法");
    }
    ...
    public ResponseVo handleNotFoundException(Exception e, HttpServletRequest request) {
        log.warn(formatException(e, request, null, true));
        return ResponseVo.error(ResponseEnum.ERROR, "请求资源不存在");
    }
    ...
    public ResponseVo handleException(Exception e, HttpServletRequest request) {
        log.warn(formatException(e, request, null, true));
        return ResponseVo.error(ResponseEnum.ERROR, "服务器内部错误");
    }
