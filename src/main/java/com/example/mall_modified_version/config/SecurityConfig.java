package com.example.mall_modified_version.config;


import com.example.mall_modified_version.advice.GlobalExceptionHandler;
import com.example.mall_modified_version.enums.ResponseEnum;
import com.example.mall_modified_version.pojo.User;
import com.example.mall_modified_version.filter.TokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static class AuthenticationEntryPointImpl implements AuthenticationEntryPoint {
        ...
        public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException {
            ...
            response.getWriter().print(objectMapper.writeValueAsString(ResponseVo.error(ResponseEnum.PARAM_ERROR, "[SpringSecurity] 认证失败，因为访问的接口需要token，但是token缺失/token无效/token过期")));
        }
    }
